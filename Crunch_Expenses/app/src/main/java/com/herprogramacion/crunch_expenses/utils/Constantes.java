...
public class Constantes {
    ...
    private static final String IP = "http://181.136.46.2";

    /**
     * URLs del Web Service
     */
/*
    public static final String GET_URL = "http://crunch.260mb.net:80/crunch_expenses/web/obtener_gastos.php";
    public static final String INSERT_URL = "http://crunch.260mb.net:80/crunch_expenses/web/insertar_gasto.php";*/
